...
if __name__ == '__main__':
    print("Запуск бота...")
    bot.run(TOKEN)
потрібно до цього коду додати команду яка в певний канал буде надсилати повідомлення якщо хтось хоче долучитися до сервера і виводити кнопки , схвалити приєднання чи скасувати, також має виводитися інформація про користувачів які приєднуються і відповідь з текстового поля яке є обов'язковим під час приєднання 