...
BAD_WORDS = [
    # Українські
    "блядь", "їбати", "хуй", "пізда", "дупа", "говно", "муділо", "залупа", "піздєц", "їбучий", "єблан", "дрочити", "срака", "шльондра", "курва", "падлюка", "пісяти", "манда", "хуйня", "піздюк", "піздюля", "їботня", "ссати", "сцикло", "срати", "скурвий", "їбисько", "їбанутий", "від’їбнутися", "їбашити", "їбнути", "під’їбати", "під’їбушка", "довбоїб", "хуйло", "хуйово", "хуїти", "хуєта", "хуєвий", "піздобол", "піздюхати", "піздун", "піздюра", "піздюліти", "піздюк", "піздюгати", "піздюцкий", "піздюшник", "піздюхати", "піздючий", "піздюшниця", "піздюшний",
    # Російські
    "блядь", "ебать", "хуй", "пизда", "жопа", "говно", "мудак", "залупа", "пиздец", "ебаный", "еблан", "дрочить", "срака", "шлюха", "сука", "мразь", "ссать", "манда", "хуйня", "пиздюк", "пиздюля", "еботня", "сцикло", "срать", "скот", "ебисько", "ебанутый", "отъебаться", "ебашить", "ебнуть", "подъебать", "подъебушка", "долбоёб", "хуйло", "херово", "хуеть", "хуета", "херовый", "пиздобол", "пиздюхать", "пиздун", "пиздюра", "пиздюлить", "пиздюк", "пиздюгать", "пиздюцкий", "пиздюшник", "пиздюхать", "пиздючий", "пиздюшница", "пиздюшный"
]
...
async def on_message(message):
    ...
    if BAD_WORDS_RE.search(message.content):
        ...
        # Надіслати DM з причиною та цитатою
        try:
            reason_text = None
            mute_time = None
            if user_warnings[user_id] == 1:
                reason_text = "Вам винесено попередження за використання нецензурної лексики."
            elif user_warnings[user_id] == 2:
                reason_text = "Вам видано мут на 1 годину за повторне використання нецензурної лексики."
                mute_time = "1 година"
            elif user_warnings[user_id] >= 3:
                reason_text = "Вам видано мут на 1 тиждень за неодноразове використання нецензурної лексики."
                mute_time = "1 тиждень"
            msg_lines = [
                f"Вас покарано на сервері **{message.guild.name}**.",
                reason_text,
                f"Ваше порушення:\n>>> {message.content}"
            ]
            if mute_time:
                msg_lines.append(f"Тривалість покарання: {mute_time}")
            await message.author.send("\n".join(msg_lines))
        except Exception:
            pass
        # Логування в адмін-канал
        try:
            admin_log_channel = message.guild.get_channel(1283457363323650089)
            if admin_log_channel:
                embed = discord.Embed(
                    title="Порушення: нецензурна лексика",
