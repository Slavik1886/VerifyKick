...
active_stats_tracking = {}  # {guild_id: {"channel_id": channel_id, "count": count}}
...
@bot.tree.command(name="voice_stats", description="Керування автоматичною статистикою голосових каналів")
...
async def voice_stats(interaction: discord.Interaction,
    ...
    if enable:
        ...
        await interaction.response.send_message(
            ...
            f"👥 Показуватиме топ {count} користувачів\n"
